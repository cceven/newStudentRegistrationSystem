                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.xingbie}</td>
                                <td>
                                    <ssm:sql var="mapxueyuan22" type="find"> SELECT xueyuanmingcheng,id FROM xueyuan where id='${map.xueyuan}' </ssm:sql
                                    >${mapxueyuan22.xueyuanmingcheng}
                                </td>
                                <td>
                                    <ssm:sql var="mapzhuanye23" type="find"> SELECT zhuanyemingcheng,id FROM zhuanye where id='${map.zhuanye}' </ssm:sql
                                    >${mapzhuanye23.zhuanyemingcheng}
                                </td>
                                <td><ssm:sql var="mapbanji24" type="find"> SELECT banjimingcheng,id FROM banji where id='${map.banji}' </ssm:sql>${mapbanji24.banjimingcheng}</td>
