            ...
            <div class="panel-body">
                <form action="xinshengupdate.do" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">学号<span
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">生源地<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <input
                                        type="text"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">学院<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <select
                                        class="form-control class_xueyuan16"
                                ...
                                >
                                    <ssm:sql var="select"
                                             type="select"> SELECT * FROM xueyuan where id='${sessionScope.xueyuan}' ORDER BY id desc </ssm:sql>
                                ...
                                <script>
                                    $(".class_xueyuan16").val($(".class_xueyuan16").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">专业<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <select
                                        class="form-control class_zhuanye17"
                                ...
                                >
                                    <ssm:sql var="select"
                                             type="select"> SELECT * FROM zhuanye where id='${sessionScope.zhuanye}' ORDER BY id desc </ssm:sql>
                                    <c:forEach items="${select}" var="m"
                                    ><c:set var="m" value="${m}" scope="request"/>
                                ...
                                <script>
                                    $(".class_zhuanye17").val($(".class_zhuanye17").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">班级<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <select
                                        class="form-control class_banji18"
                                        ...
                                        style="width: 250px"
                                >
                                    <ssm:sql var="select" type="select"> SELECT * FROM banji where id='${sessionScope.banji}' ORDER BY id desc </ssm:sql>
                                    <c:forEach items="${select}" var="m"
                                    ><c:set var="m" value="${m}" scope="request"/>
                                ...
                                <script>
                                    $(".class_banji18").val($(".class_banji18").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea style="width: 80%; height: 120px" class="form-control" placeholder="输入学生简介"
                                          id="xueshengjianjie" name="xueshengjianjie">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a  class="btn btn-default" href=diaozhuanye_add.do?id=${mmm.id}>调专业</a>
                            </div>
                        </div>
                    </div>
