...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑宿舍费用:</div>
            <div class="panel-body">
                <form action="sushefeiyongupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="feiyongbianhao"
                                    name="feiyongbianhao"
                                    value="${Info.html(mmm.feiyongbianhao)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    ...
                                    <select class="form-control class_xingbie_search15" data-value="" id="xingbie_search" name="xingbie_search">
                                        <option value="">请选择</option>
                                        <option value="男">男</option>
                                        <option value="女">女</option>
                                    </select>
                                    <select class="form-control class_xueyuan_search16" data-value="" id="xueyuan_search" name="xueyuan_search">
                                        <option value="">请选择</option>
                                    ...
                                    <select class="form-control class_zhuanye_search17" data-value="" id="zhuanye_search" name="zhuanye_search">
                                        <option value="">请选择</option>
                                    ...
                                    <select class="form-control class_banji_search18" data-value="" id="banji_search" name="banji_search">
                                        <option value="">请选择</option>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script>
                                    $(".class_xingbie19 select-update").val($(".class_xingbie19 select-update").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">宿舍费<span style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <input
                                    type="number"
                                    class="form-control"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_jiaofeizhuangtai23"
                                ...
                                <script>
                                    $(".class_jiaofeizhuangtai23").val($(".class_jiaofeizhuangtai23").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
