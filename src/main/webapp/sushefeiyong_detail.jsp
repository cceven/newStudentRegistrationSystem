...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">宿舍费用详情</div>
        <div class="panel-body">
            <div class="admin-detail clearfix">
                <div class="detail detail-text">
                    <div class="detail-title">费用编号：</div>
                    <div class="detail-content">${map.feiyongbianhao}</div>
                </div>
                <div class="detail detail-text">
                ...
                <div class="detail detail-select">
                    ...
                    <div class="detail-content">
                        <ssm:sql var="mapxueyuan7"
                                 type="find"> SELECT xueyuanmingcheng,id FROM xueyuan where id='${map.xueyuan}' </ssm:sql>${mapxueyuan7.xueyuanmingcheng}
                    </div>
                </div>
                <div class="detail detail-select">
                    <div class="detail-title">专业：</div>
                    <div class="detail-content">
                        <ssm:sql var="mapzhuanye8"
                                 type="find"> SELECT zhuanyemingcheng,id FROM zhuanye where id='${map.zhuanye}' </ssm:sql>${mapzhuanye8.zhuanyemingcheng}
                    </div>
                </div>
                <div class="detail detail-select">
                    <div class="detail-title">班级：</div>
                    <div class="detail-content">
                        <ssm:sql var="mapbanji9"
                                 type="find"> SELECT banjimingcheng,id FROM banji where id='${map.banji}' </ssm:sql>${mapbanji9.banjimingcheng}
                    </div>
                </div>
                <div class="detail detail-select">
                ...
                <div class="detail detail-money">
                    <div class="detail-title">宿舍费：</div>
                    <div class="detail-content">${map.sushefei}</div>
                </div>
            </div>
