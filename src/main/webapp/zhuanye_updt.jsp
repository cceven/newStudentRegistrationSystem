    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="zhuanyeupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=update&id=${mmm.id}&table=zhuanye&col=zhuanyemingcheng"
                                    data-msg-remote="内容重复了"
                                    id="zhuanyemingcheng"
                                    name="zhuanyemingcheng"
                                    value="${Info.html(mmm.zhuanyemingcheng)}"
                                />
                            </div>
                        </div>
                    </div>
