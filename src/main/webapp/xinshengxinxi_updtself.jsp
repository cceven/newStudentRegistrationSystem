                ...
                <form action="xinshengxinxiupdate.do" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_xingbie2" data-value="${Info.html(mmm.xingbie)}" id="xingbie" name="xingbie" style="width: 250px">
                                    <option value="男">男</option>
                                    <option value="女">女</option>
                                </select>
                                <script>
                                    $(".class_xingbie2").val($(".class_xingbie2").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                   ...
                   <%-- <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_fenpeisushe4" data-value="${Info.html(mmm.fenpeisushe)}" id="fenpeisushe" name="fenpeisushe" style="width: 250px">
                                    <option value="未分配">未分配</option>
                                    <option value="已分配">已分配</option>
                                </select>
                                <script>
                                    $(".class_fenpeisushe4").val($(".class_fenpeisushe4").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>--%>
                    <%--<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xuefeijiaofei5"
                                ...
                                <script>
                                    $(".class_xuefeijiaofei5").val($(".class_xuefeijiaofei5").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>--%>
                    <%--<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_sushejiaofei6"
                                ...
                                <script>
                                    $(".class_sushejiaofei6").val($(".class_sushejiaofei6").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>--%>
