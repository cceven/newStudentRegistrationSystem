...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加宿舍信息:</div>
            <div class="panel-body">
                <form action="sushexinxiinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=insert&table=sushexinxi&col=sushehao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_susheleixing24"
                                    data-value=""
                                    data-rule-required="true"
