...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑宿舍分配:</div>
            <div class="panel-body">
                <form action="sushefenpeiupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <input type="hidden" name="sushexinxiid" value="${mmm.sushexinxiid}" />
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">宿舍号</label>
                            <div class="col-sm-10">${mmm.sushehao}<input type="hidden" id="sushehao" name="sushehao" value="${Info.html(mmm.sushehao)}" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">宿舍类型</label>
                            <div class="col-sm-10">${mmm.susheleixing}<input type="hidden" id="susheleixing" name="susheleixing" value="${Info.html(mmm.susheleixing)}" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=update&id=${mmm.id}&table=sushefenpei&col=chuangweihao"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    ...
                                    <select class="form-control class_xingbie_search16" data-value="" id="xingbie_search" name="xingbie_search">
                                        <option value="">请选择</option>
                                        <option value="男">男</option>
                                        <option value="女">女</option>
                                    </select>
                                    <select class="form-control class_xueyuan_search17" data-value="" id="xueyuan_search" name="xueyuan_search">
                                        <option value="">请选择</option>
                                    ...
                                    <select class="form-control class_zhuanye_search18" data-value="" id="zhuanye_search" name="zhuanye_search">
                                        <option value="">请选择</option>
                                    ...
                                    <select class="form-control class_banji_search19" data-value="" id="banji_search" name="banji_search">
                                        <option value="">请选择</option>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script>
                                    $(".class_xueyuan20 select-update").val($(".class_xueyuan20 select-update").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script>
                                    $(".class_zhuanye21 select-update").val($(".class_zhuanye21 select-update").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script>
                                    $(".class_banji22 select-update").val($(".class_banji22 select-update").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    name="fenpeishijian"
                                    readonly="readonly"
                                    value="${Info.html(mmm.fenpeishijian)}"
                                />
                            </div>
                        </div>
                    </div>
